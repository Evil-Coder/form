<template>
	<fieldset class="address">
		...
		<div class="address__index field"
			...
			<p class="field__error" v-if="$v.index.$error">Пожалуйста напишите индекс корректно</p>
		</div>
		<div class="address__country field"
			...
			<p class="field__error" v-if="$v.country.$error">Пожалуйста напишите страну корректно</p>
		</div>
		...
		<div class="address__city field"
			...
			<p class="field__error" v-if="$v.city.$error">Пожалуйста напишите город корректно</p>
			<p class="field__warning" v-if="!$v.city.required && send">Пожалуйста напишите город</p>
		</div>
		<div class="address__street field"
			...
			<p class="field__error" v-if="$v.street.$error">Пожалуйста напишите улицу корректно</p>
		</div>
...
export default {
  name: "Address",
	...
	validations: {
		...
		street: { alpha: val => /^[а-яё]*$/i.test(val), minLength: minLength(2) },
		house: { numeric }
	}
}
</script>
